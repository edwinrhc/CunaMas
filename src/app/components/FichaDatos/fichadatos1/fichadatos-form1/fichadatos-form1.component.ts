  ...
  onSaveFormFichaDatos1(){
    ...
    if(this.fichadatos1Service.selected.id == null){
      ...
      let newFichaDatos1=  {
        ...
        B10REFERENCIA: this.fichadatos1Service.selected.B10REFERENCIA,
        ...
        D1NOMBRE: this.fichadatos1Service.selected.D1NOMBRE,
        D2APELLIDOP: this.fichadatos1Service.selected.D2APELLIDOP,
        D3APELLIDOM: this.fichadatos1Service.selected.D3APELLIDOM,
        D4DNI: this.fichadatos1Service.selected.D4DNI,
        ...
        RESULTADO_TARJETA: this.fichadatos1Service.selected.RESULTADO_TARJETA,
